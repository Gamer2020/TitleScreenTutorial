...
const u32 gTest_Mon[] = INCBIN_U32("graphics/pokemon/anim_front_pics/charizard_front_pic.4bpp.lz");
const u32 gTestPal_Mon[] = INCBIN_U32("graphics/pokemon/palettes/charizard_palette.gbapal.lz");
